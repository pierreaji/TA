...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet"
        href="{{ asset('assets') }}/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
...
<body>
    ...
    <div class="position-relative">
        <div class="authentication-wrapper authentication-basic container-p-y">
            <div class="authentication-inner py-4">
                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-bold">SyncMas</span>
                        </a>
                    </div>
                    <!-- /Logo -->

                    <div class="card-body mt-2">
                        {{-- <h4 class="mb-2 fw-semibold">SyncMas Forgot Password 👋</h4> --}}
                        <p class="mb-4">Please input your email!</p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('password.email') }}" method="POST">
                            ...
                            <div class="mb-3 d-flex justify-content-between">
                                <a href="{{ url('login') }}" class="float-end mb-1">
                                    <span>Or Login Here</span>
                                </a>
                            </div>
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit">Forgot Password</button>
                            </div>
                        </form>
                ...
                <!-- /Login -->
                <img alt="mask"
                    src="{{ asset('assets') }}/assets/img/illustrations/auth-basic-login-mask-light.png"
    ...
    <!-- Vendors JS -->
    <script src="{{ asset('assets') }}/assets/vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
    <script src="{{ asset('assets') }}/assets/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
    <script src="{{ asset('assets') }}/assets/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>
